...
plt.plot(x, x * spm * 12, "--", label="R=0%")
plt.plot(x, f(x, 0.03), label="R=3%")
plt.plot(x, f(x, 0.05), label="R=5%")
plt.plot(x, f(x, 0.07), label="R=7%")
plt.plot(x, f(x, 0.10), label="R=10%")
